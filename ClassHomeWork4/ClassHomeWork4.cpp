...
#define TASK 2  // поменяйте значение TASK что бы разблокировать задание 
...
public:
	//Я попыталась воспользоваться делегированием конструкторов,
	//но из-за того что конструкторы вызывают друг друга count прибавляет лишние объекты 
	//Я думаю, что можно поместить счетчик в метод вывода информации, что бы счетчик правильно считал
	...
	//Конструкторы, который не используют делегирование 
	/*
	MyString()
	{
		size = 80;
